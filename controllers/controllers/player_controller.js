			...
			models.Player.find({
				...
				if (player) {
					models.Photo.findAll({
						...
						//console.log(player);
						res.render('players/show',{ gymko: req.gymko, kotos: kotos, player: player, photos: photos, notes: notes, errors: []});
					});
				} else {
						res.render('players/show',{ gymko: req.gymko, kotos: kotos, player: player, notes: notes, errors: []});
				}
	})})});
};
